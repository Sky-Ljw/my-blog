...
declare function chatInlineLayout(): (props: ChatLayoutTemplateData) => h.JSX.Element;

declare type ChatLayoutTemplateData = Omit<ChatLayoutOwnProps, 'headerComponent' | 'messagesComponent' | 'promptComponent' | 'toggleButtonComponent'> & {
    templates: {
        header: () => JSX.Element;
