...
Object.defineProperty(exports, "createChatMessagesComponent", {
    enumerable: true,
    get: function() {
        return createChatMessagesComponent;
    }
});
...
var _chat = require("../../lib/utils/chat");
...
var copyToClipboard = function copyToClipboard(message) {
    navigator.clipboard.writeText((0, _chat.getTextContent)(message));
};
function createDefaultMessageComponent(param) {
    ...
    return function DefaultMessage(param) {
        ...
        var defaultAssistantActions = _to_consumable_array._((0, _chat.hasTextContent)(message) ? [
            {
                title: translations.copyToClipboardLabel,
                icon: function icon() {
                    return /*#__PURE__*/ createElement(_icons.CopyIcon, {
                        createElement: createElement
                    });
                },
        ...
        ] : []).concat([
            {
                ...
                icon: function icon() {
                    return /*#__PURE__*/ createElement(_icons.ReloadIcon, {
                        createElement: createElement
                    });
                },
            ...
            if (isSending) {
                ...
                defaultAssistantActions.push({
                    ...
                    icon: function icon() {
                        ...
                        }, /*#__PURE__*/ createElement(_icons.CheckIcon, {
                            createElement: createElement
                ...
                defaultAssistantActions.push({
                    ...
                    icon: function icon() {
                        return /*#__PURE__*/ createElement(_icons.ThumbsUpIcon, {
                            createElement: createElement
                        });
                    },
                    onClick: function onClick(m) {
                    ...
                    icon: function icon() {
                        return /*#__PURE__*/ createElement(_icons.ThumbsDownIcon, {
                            createElement: createElement
                        });
                    },
                    onClick: function onClick(m) {
        ...
        return /*#__PURE__*/ createElement(ChatMessage, _object_spread._({
...
function createChatMessagesComponent(param) {
    ...
    return function ChatMessages(userProps) {
        ...
        var isStreamingNonTextContent = status === 'streaming' && lastPart && !(0, _chat.isPartText)(lastPart);
        ...
        }, /*#__PURE__*/ createElement(_icons.ChevronDownIcon, {
            createElement: createElement
        })));
    };
}
