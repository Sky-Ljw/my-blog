...
import type { ChatClassNames, ChatHeaderProps, ChatLayoutOwnProps, ChatMessageActionProps, ChatMessageBase, ChatMessageErrorProps, ChatMessageLoaderProps, ChatPromptProps, ChatToggleButtonProps, ClientSideToolComponentProps, ClientSideTools, RecordWithObjectID, UserClientSideTool } from 'instantsearch-ui-components';
...
export type ChatLayoutTemplateData = Omit<ChatLayoutOwnProps, 'headerComponent' | 'messagesComponent' | 'promptComponent' | 'toggleButtonComponent'> & {
    templates: {
        header: () => JSX.Element;
